...
const Footer = () => (
    ...
    flex-col`}>
       ...
       <div className='w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3e45]'>
          <p className='font-poppins font-normal text-center text-[18px] leading-[18px]  text-white'>
          ...
          <div className='flex flex-row md:mt-0 mt-6'>
            {socialMedia.map((social,index)=>(
              ...
              className={`w-[21px] h-[27px] object-contain curosr-pointer ${index !== socialMedia.length-1 ? 'mr-6' : 'mr-0' }`}/>
            ))}
